...
func sendJSON(w http.ResponseWriter, resp Response, status int){
	...
	if err != nil {
		slog.Error("faile to marshal json data", "error", err)
		sendJSON(
			w,
	...
	if _, err := w.Write(data); err != nil {
		slog.Error("failed to write response t o client", "error", err)
		return
	}
}
...
const characters = "abcdfghijklmnopqrstuvwxyzABCDFGHIJKLMNOPQRSTUVWXYZ0123456789"
